...
exit_docs="$(cat "${ROOT}/docs/features/exit-node.md")"
expect_contains "${exit_docs}" "exit node" "docs document exit node"
expect_contains "${exit_docs}" "advertise-exit-node" "docs mention --advertise-exit-node"
expect_contains "${exit_docs}" "Use as exit node" "docs document admin approval"
expect_contains "${exit_docs}" "MASQUERADE" "docs document NAT/MASQUERADE path"
expect_contains "${exit_docs}" "rp_filter" "docs document rp_filter hardening"
